-- Populate Schema
    ...
    --pop shipping methods
        INSERT INTO shipping_type (type) VALUES ('Next Day (Next day by end of day)');
        INSERT INTO shipping_type (type) VALUES ('2nd Day (2 business days)');
        INSERT INTO shipping_type (type) VALUES ('3 Day (3 business days)');
        INSERT INTO shipping_type (type) VALUES ('Ground (1-5 business days)');

    --pop materials
        INSERT INTO materials (type) VALUES ('Canvas');
        INSERT INTO materials (type) VALUES ('Poster Paper (Gloss)');
        INSERT INTO materials (type) VALUES ('Regular (Matte)');
        INSERT INTO materials (type) VALUES ('Wood Transfer');

    -- pop sizes
        INSERT INTO sizes (orientation, width, height) VALUES ('Landscape', 11, 8);
        INSERT INTO sizes (orientation, width, height) VALUES ('Landscape', 36, 21);
        INSERT INTO sizes (orientation, width, height) VALUES ('Portrait', 17, 21);